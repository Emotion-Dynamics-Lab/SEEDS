...
This script will process the data from the Part 1: Regulation of Emotion Systems Survey.
...
```{r}
df_scale <-  select(df[-c(1,2,3),], X.5 , X..Q...Q60.ChoiceTextEntryValue..:X..Q...Q83.ChoiceTextEntryValue..) 
head(df_scale)
```
...
colnames(df_scale)[colnames(df_scale)=="X..Q...Q60.ChoiceTextEntryValue.."] <- "ress_1"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q61.ChoiceTextEntryValue.."] <- "ress_2"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q62.ChoiceTextEntryValue.."] <- "ress_3"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q63.ChoiceTextEntryValue.."] <- "ress_4"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q64.ChoiceTextEntryValue.."] <- "ress_5"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q65.ChoiceTextEntryValue.."] <- "ress_6"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q66.ChoiceTextEntryValue.."] <- "ress_7"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q67.ChoiceTextEntryValue.."] <- "ress_8"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q68.ChoiceTextEntryValue.."] <- "ress_9"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q69.ChoiceTextEntryValue.."] <- "ress_10"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q70.ChoiceTextEntryValue.."] <- "ress_11"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q71.ChoiceTextEntryValue.."] <- "ress_12"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q72.ChoiceTextEntryValue.."] <- "ress_13"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q73.ChoiceTextEntryValue.."] <- "ress_14"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q74.ChoiceTextEntryValue.."] <- "ress_15"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q75.ChoiceTextEntryValue.."] <- "ress_16"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q76.ChoiceTextEntryValue.."] <- "ress_17"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q77.ChoiceTextEntryValue.."] <- "ress_18"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q78.ChoiceTextEntryValue.."] <- "ress_19"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q79.ChoiceTextEntryValue.."] <- "ress_20"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q80.ChoiceTextEntryValue.."] <- "ress_21"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q81.ChoiceTextEntryValue.."] <- "ress_22"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q82.ChoiceTextEntryValue.."] <- "ress_23"
colnames(df_scale)[colnames(df_scale)=="X..Q...Q83.ChoiceTextEntryValue.."] <- "ress_24"
```
...
```{r, eval = FALSE}
#Write to Enya's Mac:
write.csv(df_scale,'/Volumes/Emotion Dynamics Lab/DREAMS (UGS2)/Data/Part 1/Term 1 Data/Regulation of Emotion Systems Survey-Part_1.csv')

#Write to Jess's Mac:
#write.csv(df_final,'/Volumes/research/Emotion Dynamics Lab/DREAMS (UGS2)/Data/Part 1/Term 1 Data/Regulation of Emotion Systems Survey-Part_1.csv')
```
