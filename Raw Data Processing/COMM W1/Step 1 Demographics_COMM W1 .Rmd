...
#For "GenderTrajectoryNeitherCisgenderNorTransgenderText", 2 participants answered "male"/"Male", change these to NA:
demo_scale$GenderTrajectoryNeitherCisgenderNorTransgenderText[demo_scale$GenderTrajectoryNeitherCisgenderNorTransgenderText %in% c("male","Male ")] <- NA
# Check other responses next time I run
...
demo_core <- subset(demo_scale, select = c(id, sgm, GenderIdentity, SexualOrientation, Ethnicity, Age_Years, Ladder, InternationalDomesticStudent, UndergradYear, PartOrFullTime, Faculty, GPA))
