...
Rename the items:
```{r}
colnames(stress_scale)[colnames(stress_scale)=="X.5"] <- "id"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q85.ChoiceTextEntryValue.."] <- "stress_1"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q86.ChoiceTextEntryValue.."] <- "stress_2"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q87.ChoiceTextEntryValue.."] <- "stress_3"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q88.ChoiceTextEntryValue.."] <- "stress_4"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q89.ChoiceTextEntryValue.."] <- "stress_5"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q90.ChoiceTextEntryValue.."] <- "stress_6"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q91.ChoiceTextEntryValue.."] <- "stress_7"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q92.ChoiceTextEntryValue.."] <- "stress_8"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q93.ChoiceTextEntryValue.."] <- "stress_9"
colnames(stress_scale)[colnames(stress_scale)=="X..Q...Q94.ChoiceTextEntryValue.."] <- "stress_10"
```
